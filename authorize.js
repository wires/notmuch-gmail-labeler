...
var TOKEN_PATH = 'account-credentials.json'

var apiCredentials = require('./apiCredentials.js')

// Authorize a client with the loaded credentials, then call the
// Gmail API.
authorize(apiCredentials, listLabels)
...
function authorize (credentials, callback) {
  ...
  // pull out the rest of the config
  var clientSecret = base.client_secret
  var clientId = base.client_id
  var redirectUrl = base.redirect_uris[0]
